 ...
 */
    ...
    get_campaign_install_inserts: function(parameters){
        switch (parameters.attributionService){
            ...
            {
                init(parameters);
                parameters.campaign_id = 'korune-guardian55ef590c8f1d65a3bb8228eb60';
                kochava.enqueue_get_installs(parameters);
                parameters.campaign_id = 'korune-guardian55ef590c8f1d6e1b0c13b0bb66';
                kochava.enqueue_get_installs(parameters);
                parameters.campaign_id = 'korune-guardian55ef590c8f1d6';
                kochava.enqueue_get_installs(parameters);
...
function init(parameters){
    ...
    // loop through all the appropriate app_ids
    parameters.app_id = 'korune-guardian55ef590c8f1d6';    
}